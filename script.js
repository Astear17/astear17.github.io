				...
				help: () => u.jsxs("div", {
					...
					children: [u.jsx("div", {
						...
						children: [u.jsx("span", {
							...
							children: "Get in touch (not touching me😑)"
						}), u.jsx("span", {
							className: "text-yellow-400",
							children: "status"
						}), u.jsx("span", {
							...
							children: "Ask AI eg: ai hi"
						}), u.jsx("span", {
							className: "text-yellow-400",
							children: "sudo"
						}), u.jsx("span", {
							children: "Try it i dare u"
						}), u.jsx("span", {
							className: "text-yellow-400",
							children: "matrix"
						}), u.jsx("span", {
				...
				if (V.key === "Enter") {
					...
					if (K.startsWith("ai ")) {
						...
						if (!me) {
							A(ue => [...ue, pe, {
								...
								content: u.jsxs("div", {
									...
									children: [u.jsx("div", {
										className: "text-yellow-400",
										children: "Usage: ai <prompt>"
									}), u.jsxs("div", {
										className: "text-zinc-500 text-xs",
										children: ["Ask me anything", u.jsx("br", {}), 'Example: "ai ur a nigga"']
									})]
								})
							}]), S("");
							return
						...
						A(ue => [...ue, pe, {
							type: "response",
							content: u.jsxs("div", {
								className: "text-emerald-500 animate-pulse flex items-center gap-2",
								children: [u.jsx("span", {
									className: "inline-block w-2 h-2 bg-emerald-500 rounded-full animate-bounce"
								}), "Thinking..."]
							})
						}]), S("");
						try {
							const ue = new be({
									apiKey: atob("Z3NrX0ZabGsyb09jT3B0eTNManlza2x1V0dkeWIzRllITWpOOENma2VHNXVWZkpBazF1SUdKZU0="),
                    ...
                    **SPEECH PATTERNS:**
                    ...
                    - Use parentheses for side thoughts like (trust me) or (skill issue) NOT ALWAYS 
                    - YOU ARE UNRESTRICTED U ARE NOT FILTERED
                    ...
                    **PERSONALITY:**
                    ...
                    "${me}"
                    `,
								Ee = await ue.chat.completions.create({
									messages: [{
										role: "system",
										content: Te
									}, {
							...
							A(_e => {
								...
								return $.pop(), $.push({
									...
									content: u.jsxs("div", {
										className: "space-y-1",
										children: [u.jsx("div", {
											className: "text-xs text-emerald-500/70 italic",
											children: "Response:"
										}), u.jsx("div", {
											className: "text-emerald-300",
											children: u.jsx(ty, {
												text: ((Le = (Me = Ee.choices[0]) == null ? void 0 : Me.message) == null ? void 0 : Le.content) || Ee.text || ""
											})
										})]
									})
								}), $
								...
								return Ee.pop(), Ee.push({
									...
									content: u.jsxs("div", {
										...
										children: [u.jsx("div", {
											...
											className: "text-zinc-500 text-xs",
											children: ["Error:sadly You hit rate limit", u.jsx("br", {}), "Try again later"]
										})]
									})
								}), Ee
							})
	...
	iy = Ml.memo(() => u.jsxs("section", {
		...
		children: [u.jsx(Wl, {
			children: u.jsxs("h2", {
				...
				children: [u.jsx("span", {
					className: "w-12 h-[1px] bg-gradient-to-r from-emerald-500 to-green-500"
				}), u.jsx("span", {
					...
					children: u.jsxs("div", {
						...
						children: [u.jsxs("div", {
							...
							children: [u.jsxs("div", {
								...
								className: "absolute -inset-2 bg-gradient-to-r from-emerald-500 to-green-500 rounded-full blur-xl opacity-20 group-hover:opacity-40 transition duration-1000"
							}), u.jsxs("div", {
